            ...
            <div className="px-6 py-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-3 border-2 border-primary/30 text-primary font-semibold rounded-lg hover:bg-primary hover:text-black transition-all duration-200"
                >
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-3 border-2 border-primary/30 text-primary font-medium rounded-lg hover:bg-primary hover:text-black transition-all duration-200"
                >
                  Manage Preferences
                </button>
                <button
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#fefdf9] rounded-xl shadow-2xl border-2 border-accent/30 w-full max-w-md overflow-hidden">
            ...
            <div className="px-6 py-4 border-t border-accent/20 flex space-x-3 bg-gradient-to-r from-[#f9f6ed] to-[#fefdf9]">
              <button
                onClick={() => setShowPreferences(false)}
                className="flex-1 px-4 py-2 border-2 border-primary/30 text-primary font-medium rounded-lg hover:bg-primary hover:text-black transition-all duration-200"
              >
                Cancel
              </button>
              <button
