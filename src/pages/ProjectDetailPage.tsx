...
const ProjectDetailPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{project.title} | The Lys Foundation</title>
              ...
              <div className="lg:col-span-1">
                ...
                >
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    <Link
                      to="/contact"
                      className="block w-full py-3 bg-primary text-black text-center font-medium rounded-xl hover:bg-primary-light transition-colors"
                    >
                      Get Involved
                    </Link>
                  </div>
