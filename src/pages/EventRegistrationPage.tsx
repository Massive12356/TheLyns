...
const EventRegistrationPage = () => {
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/events"
                  className="inline-flex items-center justify-center px-8 py-3 bg-primary text-black font-semibold rounded-full hover:bg-primary-dark transition-colors"
                >
                ...
                <Link
                  to="/"
                  className="inline-flex items-center justify-center px-8 py-3 border-2 border-primary text-primary font-semibold rounded-full hover:bg-primary hover:text-black transition-colors"
                >
                  Go to Home
                </Link>
              </div>
  ...
  return (
    <>
      <Helmet>
        <title>Register for {event.title} | The Lys Foundation</title>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <label className="flex items-start space-x-3 p-4 bg-accent/5 rounded-xl cursor-pointer">
                      ...
                      <span className="text-secondary text-sm">
                        I agree to receive communications about this event and future Lys Foundation events.
