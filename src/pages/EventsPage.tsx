...
const EventsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Events & Programs | The Lys Foundation</title>
        <meta name="description" content="Join The Lys Foundation events — Open Days, Mother Empowerment Workshops, Speech & Prize Day, and sponsor drives across Ghana." />
      </Helmet>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center w-full px-6 py-3 bg-primary text-black font-medium rounded-full hover:bg-primary-light transition-colors mb-4"
                    >
                      Register Now
