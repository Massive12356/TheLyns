...
const DonatePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Donate | The Lys Foundation</title>
        <meta name="description" content="Support The Lys Foundation in providing Montessori education, daily meals, and mother empowerment for underprivileged families in Ghana." />
      </Helmet>
      ...
      >
        ...
        <section className="relative py-24 bg-primary overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Your contribution directly funds Montessori education, daily meals, school uniforms, and mother empowerment for children who cannot afford them.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-secondary max-w-2xl mx-auto">
                Every contribution directly supports a child's access to quality Montessori education and care.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: '$10 - Daily Meals',
                  description: 'Provides breakfast and lunch for a child for a full week, fuelling their learning and growth.',
                  icon: Heart
                },
                {
                  title: '$50 - Learning Materials',
                  description: 'Covers Montessori learning materials, books, uniforms, and stationery for a pupil.',
                  icon: Wallet
                },
                {
                  title: '$100+ - Sponsor a Child',
                  description: 'Sponsors a child for a term — covering tuition, meals, health checks, and grooming essentials.',
                  icon: Building2
                }
              ].map((item, index) => (
                <motion.div
            ...
            >
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="bg-background rounded-2xl p-8 border-2 border-accent/20 text-center">
                  ...
                  <Link
                    to="/contact"
                    className="inline-flex items-center px-8 py-4 bg-primary text-black font-semibold rounded-full hover:bg-primary-dark transition-all duration-300 group"
                  >
                    Contact Us
