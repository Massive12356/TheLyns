...
const SuccessStoriesPage = () => {
  return (
    <>
      <Helmet>
        <title>Success Stories | The Lys Foundation</title>
        <meta name="description" content="Read inspiring success stories from The Lys Foundation — children and mothers whose lives have been transformed through quality education and empowerment." />
        <meta property="og:title" content="Success Stories | The Lys Foundation" />
        <meta property="og:description" content="Real children. Real growth. Real impact." />
      </Helmet>
      ...
      >
        ...
        <section className="relative py-32 bg-primary overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Every story is a testament to the power of compassion and quality education. Meet the children and mothers whose lives have been transformed by your generosity.
            </motion.p>
          </div>
        </section>
              ...
              >
                ...
                <div>
                  ...
                  {story.recoveryTimeline && (
                    <div className="mb-6">
                      <h4 className="text-lg font-display font-semibold text-primary mb-3">Journey Timeline</h4>
                  ...
                  <Link
                    to="/donate"
                    className="inline-flex items-center px-8 py-3 bg-accent text-black font-semibold rounded-full hover:bg-accent-light transition-all duration-300"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-display font-bold text-primary mt-2 mb-4">
                Pupil & Mother Stories
              </h2>
              <p className="text-secondary max-w-2xl mx-auto">
                Each story represents hope, resilience, and the life-changing power of accessible education.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
                Your donation can sponsor the next child and give another family the chance to break the cycle of poverty through quality education.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/donate"
                  className="inline-flex items-center px-8 py-4 bg-accent text-black font-semibold rounded-full hover:bg-accent-light transition-all duration-300"
                >
                  <Heart className="w-5 h-5 mr-2" />
                  Donate Now
                </Link>
