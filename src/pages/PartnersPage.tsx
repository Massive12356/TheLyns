...
const PartnersPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Partner With Us | The Lys Foundation</title>
        <meta name="description" content="Partner with The Lys Foundation to expand access to quality Montessori education and empower single mothers across Ghana." />
      </Helmet>
        ...
        <section className="relative py-24 bg-primary overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.span
              ...
              transition={{ duration: 0.5 }}
              className="inline-block px-4 py-2 bg-white/20 text-white text-sm font-medium rounded-full mb-6 backdrop-blur-sm border border-white/20"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-secondary max-w-2xl mx-auto">
                Collaborating with The Lys Foundation offers unique opportunities for organisations committed to educational equity and child development.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  icon: Users,
                  title: 'Talent Access',
                  description: 'Engage with educators, Montessori specialists, and volunteers serving underprivileged children across Ghana.'
                },
                {
                  icon: Lightbulb,
                  title: 'Innovation',
                ...
                },
                {
                  ...
                  description: 'Showcase your commitment to educational equity through our programmes and outreach events.'
                }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
              ...
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full py-4 bg-gradient-to-r from-primary to-primary-light text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 flex items-center justify-center group disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {isLoading ? (
                        <>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-secondary max-w-md mx-auto">
                    Thank you for your interest in partnering with The Lys Foundation. Our team will review your inquiry and contact you within 5 business days.
                  </p>
                </div>
              )}
            </div>
